...
const FeaturedReceipe = () => {
    return (
        <>
            <section className="featured-receipe-section w-full relative bg-pink-50">
                <div className=" absolute right-[2%] opacity-[.5] blur-[70px] top-[30%] pink bg-pink-600 h-20 w-96 rotate-45"></div>
                <div className=" absolute right-[20%] opacity-[.5] blur-[70px] top-[70%] pink bg-primary h-20 w-96 rotate-90"></div>
                <div className="container block m-auto xl:flex justify-between items-center py-8 gap-12">
                    ...
                    <div className="featured-receipe-right pt-10 xl:pt-0  xl:w-1/2 text-center xl:text-left">
                        <h2 className=" text-[30px] xl:text-[48px] xl:leading-[55px]  text-textColor">
                            ...
                            <span className="text-primary">Debitis explicabo.</span>
                        </h2>
                        <p className="py-8 text-gray-500 font-paragraphFont">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur,
                            iure placeat? Id aspernatur velit obcaecati incidunt? Ut reprehenderit
                            consequatur laborum!
                        </p>
                        ...
                        <Link
                            ...
                            View Full Receipe <IoIosArrowRoundForward />
                        </Link>
                    </div>
                </div>
            </section>
